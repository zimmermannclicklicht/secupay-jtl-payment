        ...
        if (isset($paymentMethod)) {
            ...
            if ($paymentMethod->finalizeOrder($order, $sessionHash, $_REQUEST)) {
                ...
                if (strlen($cEditZahlungHinweis) > 0) {
                    echo gibShopURL() . '/bestellvorgang.php?editZahlungsart=1&nHinweis=' . $cEditZahlungHinweis . '&' . SID;
                } else {
                    echo gibShopURL() . '/bestellvorgang.php?editZahlungsart=1&' . SID;
                }
            }
        }
    } else {
